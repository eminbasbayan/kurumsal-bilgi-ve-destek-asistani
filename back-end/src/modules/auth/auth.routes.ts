...
import { HttpError, isRecord, requiredText } from "../../shared/http.js";
...
export function createPublicAuthRouter(db: DatabaseSync): Router {
  ...
  router.post("/login", (req, res) => {
    if (!isRecord(req.body)) throw new HttpError(400, "E-posta ve parola zorunludur.");
    const email = requiredText(req.body.email, "E-posta ve parola zorunludur.").toLowerCase();
    const password = requiredText(req.body.password, "E-posta ve parola zorunludur.");
